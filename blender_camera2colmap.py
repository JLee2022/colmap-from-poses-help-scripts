...
if 'cx' in meta:
    ...
    cx = 0.5 * W
    cy = 0.5 * H
with open('colmapprocessing/created/sparse/cameras.txt', 'w') as f:
...
with open('colmapprocessing/created/sparse/images.txt', 'w') as f:
    idx = 1
    for fname in fnames:
...
with open('colmapprocessing/created/sparse/points3D.txt', 'w') as f:
   f.write('')
